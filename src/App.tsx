        ...
        <section id="aboutSection">
          ...
          <div className="buttonContainer">
            <div className="aboutButton">
              ...
              <h6>Service</h6>
              <p>
                Ob PKW, Neuwagen, Oldtimer oder LKW – wir bieten spezialisierte
                Aufbereitungsservices für jedes Fahrzeug und bringen es in
                Bestform.
              </p>
            </div>
            <div className="aboutButton">
            ...
            <div className="aboutButton">
              ...
              <h6>Service</h6>
              <p>
                Kleine Dellen, Beulen oder Kratzer entfernen wir mühelos, um die
                makellose Optik Ihres Fahrzeugs wiederherzustellen.
              </p>
            </div>
          </div>
          <hr />
            ...
            <div className="about">
              ...
              <div className="local tb">
                ...
                <p className="text">
                  ...
                  angeschlossenen Veranda mit seitlichem Blick auf die Bocholter
                  Innenstadt finden sich unter einer Sonnensegelüberdachung
                  weitere 50 Plätze.
                </p>
              </div>
              <div className="occasions">
                ...
                <p className="text">
                  ...
                  Veranstaltungen, wie Geburtstage oder Hochzeiten aus mit einer
                  Vielzahl an Menüvorschlägen nach Ihren Wünschen und gestalten
                  unser Restaurant in eine erstklassige Party-Location.
                </p>
              </div>
            </div>
